(function (root, factory) {
  if(typeof define === 'function' && define.amd) {
    define(['video.js'], function(videojs){
      return (root.Background = factory(videojs));
    });
  } else if(typeof module === 'object' && module.exports) {
    module.exports = (root.Background = factory(require('video.js')));
  } else {
    root.Background = factory(root.videojs);
  }
  ...
  function updateSize(settings, player) {
    ...
    if (containerAspect < settings.mediaAspect) {
      ...
      //console.log(videoEl.style.width + "x" + videoEl.style.height);
    }
